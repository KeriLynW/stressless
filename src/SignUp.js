    ...
    return (
        <div className="signnup">
            ...
            <div className="signup-form">
                ...
                <input className="laput" type="password" id="pass" onChange={updatePassword} required/><br/><br/>
                <label className="laput" for="c-pass-s"> Confirm Password:  </label>
                <input className="laput" type="password" id="pass2" onChange={updatePassword2} required/><br/><br/>
